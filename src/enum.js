...
(function (AuthType) {
  ...
  AuthType['JWT'] = 'jwt';
  AuthType['APPWRITE'] = 'appwrite';
})(AuthType || (AuthType = {}));

/** Social auth type enum */
export let SocialAuthType;

(function (SocialAuthType) {
  SocialAuthType['CORE'] = 'core';
  SocialAuthType['SUPABASE'] = 'supabase';
  SocialAuthType['FIREBASE'] = 'firebase';
  SocialAuthType['APPWRITE'] = 'appwrite';

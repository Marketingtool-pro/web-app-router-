  ...
  const primaryPalette = [
    {
      ...
      figmaLabel:
        colorScheme === "dark"
          ? "Primary Container / On Primary Fixed Variant"
    ...
    },
    {
      ...
      figmaLabel:
        colorScheme === "dark"
          ? "On Primary Container / Primary Fixed"
  ...
  const secondaryPalette = [
    {
      ...
      figmaLabel:
        colorScheme === "dark"
          ? "Secondary Container / On Secondary Fixed Variant"
          : "Secondary Container / Secondary Fixed",
    ...
    },
    {
      ...
      figmaLabel:
        colorScheme === "dark"
          ? "On Secondary Container / Secondary Fixed"
  ...
  const errorPalette = [
    {
      ...
      figmaLabel:
        colorScheme === "dark" ? "On Error / Error Container" : "On Error / Error Container Low",
    ...
    },
    {
      ...
      figmaLabel:
        colorScheme === "dark" ? "Error Container High" : "Error Container High / Outline",
    ...
    },
    {
      ...
      figmaLabel:
        colorScheme === "dark" ? "On Error/ Error Container" : "On Container Low / Container High",
  ...
  const warningPalette = [
    {
      ...
      figmaLabel:
        colorScheme === "dark"
          ? "On Warning / Warning Container"
          : "On Warning / Warning Container Low",
    ...
    },
    {
      ...
      figmaLabel:
        colorScheme === "dark" ? "Warning Container High" : "Warning Container High / Outline",
    ...
    },
    {
      ...
      figmaLabel:
        colorScheme === "dark" ? "Warning Container High" : "On Container/ Warning Container",
    ...
    },
    {
      ...
      figmaLabel:
        colorScheme === "dark"
          ? "On Warning/ Warning Container"
          : "On Container Low / Container High",
  ...
  const infoPalette = [
    {
      ...
      figmaLabel:
        colorScheme === "dark" ? "On Info / Info Container" : "On Info / Info Container Low",
    ...
    },
    {
      ...
      figmaLabel:
        colorScheme === "dark" ? "On Info/ Info Container" : "On Container Low / Container High",
  ...
  const successPalette = [
    {
      ...
      figmaLabel:
        colorScheme === "dark"
          ? "On Success / Success Container"
          : "On Success / Success Container Low",
    ...
    },
    {
      ...
      figmaLabel:
        colorScheme === "dark" ? "Success Container High" : "Success Container High / Outline",
    ...
    },
    {
      ...
      figmaLabel:
        colorScheme === "dark" ? "Success Container High" : "On Container/ Success Container",

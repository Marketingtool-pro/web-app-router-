      ...
      {Icon && (
        <Box
          sx={{
            ...
            height: 28,
            borderRadius: 1.5,
            bgcolor: color ? `${color}12` : "rgba(255,255,255,0.05)",
            display: "flex",
            alignItems: "center",
    ...
    <Box sx={{ p: 2.5, borderRadius: 2.5, bgcolor: accentBg, border: accentBorder, minWidth: 0 }}>
      ...
      {change !== undefined && change !== null && (
        <Stack direction="row" sx={{ alignItems: "center", gap: 0.25, mt: 0.5 }}>
          {change >= 0 ? (
            <IconTrendingUp size={12} color="#3EB75E" />
          ) : (
            <IconTrendingDown size={12} color="#FF4757" />
          )}
          <Typography
            variant="caption"
            sx={{ color: change >= 0 ? "#3EB75E" : "#FF4757", fontSize: 12, fontWeight: 600 }}
          >
            {change >= 0 ? "+" : ""}
            {change}%
          </Typography>
...
function MetricGrid({ children, columns = "repeat(auto-fill, minmax(200px, 1fr))" }) {
  return <Box sx={{ display: "grid", gridTemplateColumns: columns, gap: 2 }}>{children}</Box>;
}
  ...
  return (
    <Box sx={{ borderRadius: 3, border: glass.border, overflow: "hidden" }}>
      <Box
        sx={{
          display: "grid",
          gridTemplateColumns: `2fr ${headers
            .slice(1)
            .map(() => "1fr")
            .join(" ")}`,
    ...
    <Stagger delay={0.3}>
      <Box
        sx={{
          ...
          p: "2px",
          background:
            "linear-gradient(135deg, rgba(128,90,245,0.5) 0%, rgba(27,162,219,0.35) 40%, rgba(62,183,94,0.35) 70%, rgba(255,200,118,0.3) 100%)",
        }}
      >
        <Box sx={{ bgcolor: "rgba(8,8,12,0.94)", borderRadius: 3, p: 3.5 }}>
          <Stack direction="row" sx={{ alignItems: "center", gap: 1.5, mb: 2.5 }}>
            ...
            <Typography
              variant="subtitle1"
              sx={{ fontWeight: 700, fontSize: 14, letterSpacing: 0.3 }}
            >
              {title}
            </Typography>
          </Stack>
          <Stack spacing={1}>
            {lines.map((line, i) => (
              <Typography
                key={i}
                variant="body2"
                sx={{ color: "rgba(255,255,255,0.7)", fontSize: 13.5, lineHeight: 1.8 }}
              >
                {line}
              </Typography>
            ))}
    ...
    <Stack spacing={1}>
      {warnings.map((w, i) => (
        <Alert
          ...
          sx={{
            borderRadius: 2,
            bgcolor: "rgba(255,200,118,0.06)",
            border: "1px solid rgba(255,200,118,0.15)",
          }}
        >
...
function GenericActionsList({ actions, accent = "#805AF5" }) {
  ...
  return (
    <Box>
      <SectionLabel icon={IconTarget} color={accent}>
              ...
              >
                ...
                <Box sx={{ flex: 1, minWidth: 0 }}>
                  <Stack direction="row" sx={{ alignItems: "center", gap: 1, mb: 0.25 }}>
                    <Typography
                      variant="subtitle2"
                      sx={{ fontWeight: 600, fontSize: 13, textTransform: "capitalize" }}
                    >
  ...
  return (
    <Stack spacing={3.5}>
      ...
      {(campaign.name || campaign.type) && (
        <Stagger delay={0.08}>
          <SectionLabel icon={IconBrandGoogle} color={GOOGLE_BLUE}>
            Campaign Blueprint
          </SectionLabel>
          <Box
            sx={{
              ...
              borderRadius: 2.5,
              bgcolor: glass.surface,
              border: `1px solid ${GOOGLE_BLUE}18`,
              position: "relative",
              overflow: "hidden",
            }}
          >
            ...
            >
              {[
                ...
                {
                  label: "Budget",
                  value: campaign.daily_budget ? `$${campaign.daily_budget}/day` : null,
                },
      ...
      {adGroups.length > 0 && (
        <Stagger delay={0.14}>
          <SectionLabel icon={IconTarget} color={GOOGLE_BLUE}>
            Ad Groups & Keywords
          </SectionLabel>
          <Stack spacing={1.5}>
            {adGroups.map((group, gi) => (
              <Box
                key={gi}
                sx={{ p: 2.5, borderRadius: 2.5, bgcolor: glass.surface, border: glass.border }}
              >
                <Stack
                  direction="row"
                ...
                >
                  <Typography variant="subtitle2" sx={{ fontWeight: 700 }}>
                    {group.name || `Ad Group ${gi + 1}`}
                  </Typography>
                  {group.match_type && (
                    <Chip
                      label={group.match_type}
                      size="small"
                      sx={{
                        fontSize: 10,
                        height: 22,
                        bgcolor: `${GOOGLE_BLUE}12`,
                        color: GOOGLE_BLUE,
                      }}
                    />
                  )}
      ...
      {ads.length > 0 && (
        <Stagger delay={0.2}>
          <SectionLabel icon={IconEye} color={GOOGLE_BLUE}>
            Ad Previews
          </SectionLabel>
          <Box
            sx={{
...
function MetaCampaignLaunchOutput({ output, formData }) {
  ...
  return (
    <Stack spacing={3.5}>
      ...
      {adSets.length > 0 && (
        <Stagger delay={0.1}>
          <SectionLabel icon={IconUsers} color={META_BLUE}>
            Ad Sets & Audiences
          </SectionLabel>
          <Stack spacing={1.5}>
            {adSets.map((set, si) => (
              ...
              >
                ...
                <Box sx={{ pl: 1.5 }}>
                  ...
                  >
                    <Typography variant="subtitle2" sx={{ fontWeight: 700 }}>
                      {set.name || `Ad Set ${si + 1}`}
                    </Typography>
                    {set.budget && (
                      <Chip
                        label={`$${set.budget}/day`}
                        size="small"
                        sx={{
                          bgcolor: "rgba(62,183,94,0.1)",
                          color: "#3EB75E",
                          fontWeight: 700,
                          fontSize: 12,
                        }}
                    ...
                    >
                      {set.audience.interests && (
                        <Box>
                          <Typography
                            variant="caption"
                            color="text.secondary"
                            sx={{ fontSize: 10, letterSpacing: 0.5, textTransform: "uppercase" }}
                          >
                            Interests
                          </Typography>
                          <Typography variant="body2" sx={{ mt: 0.25 }}>
                            {Array.isArray(set.audience.interests)
                              ? set.audience.interests.join(", ")
                              : set.audience.interests}
                          </Typography>
                        </Box>
                      )}
                      ...
                      {set.audience.locations && (
                        <Box>
                          ...
                          <Typography variant="body2" sx={{ mt: 0.25 }}>
                            {Array.isArray(set.audience.locations)
                              ? set.audience.locations.join(", ")
                              : set.audience.locations}
                          </Typography>
                        </Box>
                      )}
                  ...
                  {set.placements && (
                    <Stack direction="row" sx={{ gap: 0.75, mt: 1.5, flexWrap: "wrap" }}>
                      {(Array.isArray(set.placements) ? set.placements : [set.placements]).map(
                        (p, pi) => (
                          <Chip
                            key={pi}
                            label={p}
                            size="small"
                            variant="outlined"
                            sx={{ fontSize: 11, height: 24, borderColor: `${META_BLUE}30` }}
                          />
                        ),
                      )}
                    </Stack>
      ...
      {creatives.length > 0 && (
        <Stagger delay={0.18}>
          <SectionLabel icon={IconEye} color={META_BLUE}>
            Creative Previews
          </SectionLabel>
          <Box
            sx={{
              ...
              >
                ...
                <Box sx={{ px: 2, pb: 1.5 }}>
                  {cr.body && (
                    <Typography
                      variant="body2"
                      sx={{ fontSize: 13, lineHeight: 1.6, color: "rgba(255,255,255,0.8)" }}
                    >
                      {cr.body}
                    </Typography>
                  )}
                ...
                >
                  ...
                  {cr.cta && (
                    <Chip
                      label={cr.cta}
                      size="small"
                      sx={{ bgcolor: META_BLUE, color: "#fff", fontWeight: 700, fontSize: 11 }}
                    />
                  )}
                </Stack>
              </Box>
...
function ABTestOutput({ output }) {
  ...
  return (
    <Stack spacing={3.5}>
      ...
      {testPlan && (
        <Stagger delay={0.08}>
          <SectionLabel icon={IconAB2} color={AB_PURPLE}>
            Test Plan
          </SectionLabel>
          <Box
            sx={{
          ...
          >
            ...
            {testPlan.sample_size && (
              <MetricCard label="Sample Size" value={testPlan.sample_size} accent={AB_PURPLE} />
            )}
            {testPlan.statistical_power && (
              <MetricCard
                label="Statistical Power"
                value={testPlan.statistical_power}
                suffix="%"
                accent={AB_PURPLE}
              />
            )}
            {testPlan.confidence_level && (
              <MetricCard
                label="Confidence"
            ...
            sx={{
              ...
              gridTemplateColumns:
                variations.length > 2
                  ...
                  : `repeat(${(control ? 1 : 0) + variations.length}, 1fr)`,
              gap: 2,
            }}
          >
            {/* Control */}
            ...
            {variations.map((v, vi) => (
              <Box
                ...
                sx={{
                  p: 2.5,
                  borderRadius: 2.5,
                  bgcolor: `${AB_PURPLE}08`,
                  border: `1px solid ${AB_PURPLE}25`,
                  position: "relative",
                }}
              >
                <Stack
                ...
                >
                  <Chip
                    label={v.name || `VAR ${vi + 1}`}
                    size="small"
                    sx={{
                      bgcolor: `${AB_PURPLE}15`,
                      color: AB_PURPLE,
                      fontWeight: 700,
                      fontSize: 10,
                      letterSpacing: 1,
                  ...
                  {v.predicted_impact && (
                    <Typography variant="caption" sx={{ fontWeight: 700, color: "#3EB75E" }}>
                      {v.predicted_impact > 0 ? "+" : ""}
                      {v.predicted_impact}% predicted
                    </Typography>
                  )}
                </Stack>
                {v.changes && typeof v.changes === "object" ? (
                  Object.entries(v.changes).map(([k, val]) => (
                    <Box key={k} sx={{ mb: 1 }}>
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 500, color: AB_PURPLE }}>
                        {String(val)}
                      </Typography>
                    </Box>
                  ))
                  ...
                  <Typography variant="body2">
                    {typeof v === "object"
                      ? v.description || v.text || JSON.stringify(v)
                      : String(v)}
                  </Typography>
                )}
                {v.predicted_impact && (
                  <Box sx={{ mt: 1.5 }}>
                    <LinearProgress
                      variant="determinate"
                      value={Math.min(100, Math.abs(v.predicted_impact) * 5)}
                      sx={{
                        height: 4,
                        borderRadius: 2,
                        bgcolor: "rgba(255,255,255,0.06)",
                        "& .MuiLinearProgress-bar": {
                          bgcolor: v.predicted_impact > 0 ? "#3EB75E" : "#FF4757",
                          borderRadius: 2,
                        },
                      }}
                    />
  ...
  return (
    <Stack spacing={3.5}>
      ...
      {recommendations.length > 0 && (
        <Stagger delay={0.1}>
          <SectionLabel icon={IconCurrencyDollar} color={BID_CYAN}>
            Bid Recommendations
          </SectionLabel>
          <DataTable
            ...
            rows={recommendations.map((r) => [
              ...
              r.expected_change
                ? `${r.expected_change > 0 ? "+" : ""}${r.expected_change}%`
                : "\u2014",
      ...
      {budgetRealloc.length > 0 && (
        <Stagger delay={0.18}>
          <SectionLabel icon={IconChartBar} color={BID_CYAN}>
            Budget Reallocation
          </SectionLabel>
          <Stack spacing={1.5}>
            {budgetRealloc.map((item, i) => {
              const change =
                item.recommended_budget && item.current_budget
                  ? (
                      ((item.recommended_budget - item.current_budget) / item.current_budget) *
                      100
                    ).toFixed(0)
                  : null;
              return (
                <Box
                  key={i}
                  sx={{ p: 2, borderRadius: 2, bgcolor: glass.surface, border: glass.border }}
                >
                  <Stack
                    direction="row"
                  ...
                  >
                    ...
                    {change && (
                      <Chip
                        ...
                        size="small"
                        sx={{
                          bgcolor: change > 0 ? "rgba(62,183,94,0.1)" : "rgba(255,71,87,0.1)",
                          color: change > 0 ? "#3EB75E" : "#FF4757",
                          fontWeight: 700,
                          fontSize: 11,
                        }}
                      />
                    ...
                    <Box sx={{ flex: 1 }}>
                      ...
                      >
                        <Box
                          sx={{
                            height: "100%",
                            width: `${item.current_budget ? Math.min(100, (item.current_budget / Math.max(item.current_budget, item.recommended_budget || 1)) * 100) : 50}%`,
                      ...
                      >
                        ${item.current_budget?.toLocaleString() || "\u2014"}
                      </Typography>
                    </Box>
                    ...
                    <Box sx={{ flex: 1 }}>
                      ...
                      >
                        <Box
                          sx={{
                            height: "100%",
                            width: `${item.recommended_budget ? Math.min(100, (item.recommended_budget / Math.max(item.current_budget || 1, item.recommended_budget)) * 100) : 50}%`,
                            bgcolor: BID_CYAN,
                            borderRadius: 3,
                          }}
                        />
                      ...
                      >
                        ${item.recommended_budget?.toLocaleString() || "\u2014"}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
  ...
  return (
    <Stack spacing={3.5}>
      ...
      {fatigueScores.length > 0 && (
        <Stagger delay={0.1}>
          <SectionLabel icon={IconFlame} color={REFRESH_ORANGE}>
              ...
              return (
                ...
                >
                  ...
                  >
                    <Box>
                      <Typography variant="subtitle2" sx={{ fontWeight: 600 }}>
                        {item.name || item.creative_id || `Creative ${i + 1}`}
                      </Typography>
                      {item.days_running && (
                        <Typography variant="caption" color="text.secondary">
                          {item.days_running} days running
                        </Typography>
                      )}
                    </Box>
                    <Chip
                    ...
                    <Box sx={{ flex: 1 }}>
                      <LinearProgress
                        ...
                        sx={{
                          ...
                          borderRadius: 4,
                          bgcolor: "rgba(255,255,255,0.06)",
                          "& .MuiLinearProgress-bar": { bgcolor: fatigueColor, borderRadius: 4 },
                        }}
                      />
                    </Box>
                    <Typography
      ...
      {refreshSuggestions.length > 0 && (
        <Stagger delay={0.18}>
          <SectionLabel icon={IconRefresh} color={REFRESH_ORANGE}>
            Refresh Suggestions
          </SectionLabel>
          <Stack spacing={1.5}>
...
function AudienceExpansionOutput({ output }) {
  ...
  return (
    <Stack spacing={3.5}>
      ...
      {currentAudience && (
        <Stagger delay={0.08}>
          <SectionLabel icon={IconUsers} color={AUDIENCE_GREEN}>
            Current Audience
          </SectionLabel>
          <Box sx={{ p: 2.5, borderRadius: 2.5, bgcolor: glass.surface, border: glass.border }}>
            ...
            >
              ...
              {currentAudience.size && (
                <MetricCard
                  label="Audience Size"
                  value={currentAudience.size}
                  accent={AUDIENCE_GREEN}
                />
              )}
              {currentAudience.performance && (
                <MetricCard
                  label="Performance"
                  value={currentAudience.performance}
                  accent={AUDIENCE_GREEN}
                />
              )}
            </Box>
      ...
      {newSegments.length > 0 && (
        <Stagger delay={0.15}>
          <SectionLabel icon={IconTarget} color={AUDIENCE_GREEN}>
            Discovered Segments
          </SectionLabel>
          <Box
            sx={{
            ...
            {newSegments.map((seg, i) => (
              <Box
                ...
                sx={{
                  p: 2.5,
                  borderRadius: 2.5,
                  bgcolor: `${AUDIENCE_GREEN}06`,
                  border: `1px solid ${AUDIENCE_GREEN}18`,
                  position: "relative",
                  overflow: "hidden",
                }}
              >
                ...
                <Stack spacing={1}>
                  {seg.size && (
                    <Box>
                      ...
                      >
                        {typeof seg.size === "number" ? seg.size.toLocaleString() : seg.size}
                      </Typography>
                    </Box>
                  )}
                    ...
                    <Box>
                      ...
                      <Stack direction="row" sx={{ alignItems: "center", gap: 1 }}>
                        ...
                        >
                          <Box
                            sx={{
                              width: `${seg.overlap_pct}%`,
                              height: "100%",
                              bgcolor: AUDIENCE_GREEN,
                              borderRadius: 2,
                            }}
                          />
                        </Box>
                  ...
                  {seg.potential_cpa && (
                    <Box>
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 600, color: AUDIENCE_GREEN }}>
                        ${seg.potential_cpa}
                      </Typography>
                    </Box>
                  )}
...
function ScaleWinnersOutput({ output }) {
  ...
  return (
    <Stack spacing={3.5}>
      ...
      {winners.length > 0 && (
        <Stagger delay={0.1}>
          <SectionLabel icon={IconTrophy} color={SCALE_GOLD}>
            Top Performers
          </SectionLabel>
          <Stack spacing={1.5}>
            {winners.map((w, i) => {
              const medal =
                i === 0
                  ? { emoji: "\uD83E\uDD47", border: SCALE_GOLD }
                  : i === 1
                    ? { emoji: "\uD83E\uDD48", border: "#C0C0C0" }
                    : i === 2
                      ? { emoji: "\uD83E\uDD49", border: "#CD7F32" }
                      : { emoji: "", border: "rgba(255,255,255,0.06)" };
              return (
                <Box
                  key={i}
                  sx={{
                    ...
                    borderRadius: 2.5,
                    bgcolor: glass.surface,
                    border: `1px solid ${medal.border}${i < 3 ? "40" : ""}`,
                    position: "relative",
                    overflow: "hidden",
                  }}
                >
                  ...
                  >
                    <Box>
                      <Stack direction="row" sx={{ alignItems: "center", gap: 1, mb: 0.5 }}>
                        {medal.emoji && (
                          <Typography sx={{ fontSize: 18 }}>{medal.emoji}</Typography>
                        )}
                        <Typography variant="subtitle2" sx={{ fontWeight: 700 }}>
                          {w.campaign || w.name || `Campaign ${i + 1}`}
                        </Typography>
                        {w.platform && (
                          <Chip
                            label={w.platform}
                            ...
                            sx={{
                              ...
                              bgcolor:
                                w.platform === "google"
                                  ? "rgba(66,133,244,0.1)"
                                  : "rgba(6,104,225,0.1)",
                              color: w.platform === "google" ? "#4285F4" : "#0668E1",
                            }}
                          />
                        )}
                      </Stack>
                    ...
                    {w.recommended_increase && (
                      <Chip
                        label={`+${w.recommended_increase}%`}
                        size="small"
                        sx={{ bgcolor: "rgba(62,183,94,0.12)", color: "#3EB75E", fontWeight: 700 }}
                      />
                    )}
                  </Stack>
                  <Box
                    sx={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 2, mt: 1.5 }}
                  >
                    {w.roas && (
                      <Box>
                        <Typography
      ...
      {scalingPlan.length > 0 && (
        <Stagger delay={0.2}>
          <SectionLabel icon={IconTrendingUp} color="#3EB75E">
            Scaling Plan
          </SectionLabel>
          <Stack spacing={0}>
            {scalingPlan.map((phase, i) => (
              <Stack key={i} direction="row" sx={{ gap: 2, position: "relative" }}>
                ...
                >
                  ...
                  />
                  {i < scalingPlan.length - 1 && (
                    <Box sx={{ width: 2, flex: 1, bgcolor: "rgba(62,183,94,0.2)" }} />
                  )}
                </Box>
                <Box sx={{ pb: 2.5 }}>
                  <Typography variant="subtitle2" sx={{ fontWeight: 700 }}>
                    {phase.phase || phase.action || `Phase ${i + 1}`}
                  </Typography>
...
function KillUnderperformersOutput({ output }) {
  ...
  return (
    <Stack spacing={3.5}>
      ...
      <Stagger delay={0.06}>
        <GenericSummaryGrid
          summary={{ ...output.summary, wasted_spend: undefined, potential_savings: undefined }}
          accent={KILL_RED}
        />
      </Stagger>
      ...
      {underperformers.length > 0 && (
        <Stagger delay={0.12}>
          <SectionLabel icon={IconSkull} color={KILL_RED}>
            Underperformers
          </SectionLabel>
          <Stack spacing={1.5}>
              ...
              >
                ...
                <Box sx={{ pl: 1.5 }}>
                  ...
                  >
                    <Box>
                      <Typography variant="subtitle2" sx={{ fontWeight: 700 }}>
                        {item.campaign || item.name || `Item ${i + 1}`}
                      </Typography>
                      {item.reason && (
                        <Typography
                          variant="caption"
...
function RetargetingSetupOutput({ output }) {
  ...
  return (
    <Stack spacing={3.5}>
      ...
      {funnel.length > 0 && (
        <Stagger delay={0.1}>
          <SectionLabel icon={IconFilterBolt} color={RETARGET_PURPLE}>
            Retargeting Funnel
          </SectionLabel>
                ...
                <Box key={si} sx={{ flex: 1, display: "flex", alignItems: "stretch" }}>
                  <Box
                    sx={{
                      ...
                      borderRadius:
                        si === 0 ? "12px 0 0 12px" : si === funnel.length - 1 ? "0 12px 12px 0" : 0,
                      borderRight: si < funnel.length - 1 ? "none" : undefined,
                      position: "relative",
                    }}
                  >
                    {/* Stage number */}
                    ...
                    <Stack spacing={0.75}>
                      ...
                      {stage.creative_type && (
                        <Chip
                          label={stage.creative_type}
                          size="small"
                          sx={{ mt: 0.5, fontSize: 10, height: 22, bgcolor: `${color}15`, color }}
                        />
                      )}
                    </Stack>
                  </Box>
      ...
      {audiences.length > 0 && (
        <Stagger delay={0.18}>
          <SectionLabel icon={IconUsers} color={RETARGET_PURPLE}>
            Audiences
          </SectionLabel>
          <DataTable
            ...
            rows={audiences.map((a) => [
              ...
              a.source || "\u2014",
              a.size_estimate
                ? typeof a.size_estimate === "number"
                  ? a.size_estimate.toLocaleString()
                  : a.size_estimate
                : "\u2014",
            ])}
          />
    ...
    <Stack spacing={3.5}>
      ...
      {trends && (
        <Stagger delay={0.08}>
          ...
          >
            {trends.spend_change !== undefined && (
              <MetricCard
                label="Spend Trend"
                value={`${trends.spend_change > 0 ? "+" : ""}${trends.spend_change}%`}
                color={trends.spend_change > 0 ? "#FF4757" : "#3EB75E"}
                accent={REPORT_PURPLE}
              />
            )}
            {trends.conversion_change !== undefined && (
              <MetricCard
                label="Conversion Trend"
                value={`${trends.conversion_change > 0 ? "+" : ""}${trends.conversion_change}%`}
                color={trends.conversion_change > 0 ? "#3EB75E" : "#FF4757"}
                accent={REPORT_PURPLE}
              />
            )}
            {trends.cpa_change !== undefined && (
              <MetricCard
                label="CPA Trend"
                value={`${trends.cpa_change > 0 ? "+" : ""}${trends.cpa_change}%`}
                color={trends.cpa_change > 0 ? "#FF4757" : "#3EB75E"}
                accent={REPORT_PURPLE}
              />
            )}
            {trends.roas_change !== undefined && (
              <MetricCard
                label="ROAS Trend"
                value={`${trends.roas_change > 0 ? "+" : ""}${trends.roas_change}%`}
                color={trends.roas_change > 0 ? "#3EB75E" : "#FF4757"}
                accent={REPORT_PURPLE}
              />
            )}
          </Box>
      ...
      {platforms.length > 0 && (
        <Stagger delay={0.14}>
          <SectionLabel icon={IconReportAnalytics} color={REPORT_PURPLE}>
            Platform Breakdown
          </SectionLabel>
          <Box
            sx={{
          ...
          >
            {platforms.map((plat, i) => {
              ...
              const PIcon =
                plat.platform?.toLowerCase() === "google" ? IconBrandGoogle : IconBrandFacebook;
              return (
                <Box
                  key={i}
                  sx={{
                    ...
                    {plat.conversions !== undefined && (
                      <Box>
                        ...
                        <Typography
                          ...
                          sx={{ fontWeight: 700, fontFamily: '"JetBrains Mono", monospace' }}
                        >
                          {plat.conversions?.toLocaleString()}
                        </Typography>
                      </Box>
                    )}
                    {plat.cpa !== undefined && (
                    ...
                    {plat.roas !== undefined && (
                      <Box>
                        ...
                        <Typography
                          ...
                          sx={{
                            fontWeight: 700,
                            color: plat.roas >= 2 ? "#3EB75E" : "#FF4757",
                            fontFamily: '"JetBrains Mono", monospace',
                          }}
                        >
                          {plat.roas}x
                    ...
                    {plat.impressions !== undefined && (
                      <Box>
                        ...
                        <Typography
                          ...
                          sx={{ fontWeight: 600, fontFamily: '"JetBrains Mono", monospace' }}
                        >
                          {plat.impressions?.toLocaleString()}
                        </Typography>
                      </Box>
                    )}
      ...
      {topCampaigns.length > 0 && (
        <Stagger delay={0.2}>
          <SectionLabel icon={IconTrophy} color={REPORT_PURPLE}>
            Top Campaigns
          </SectionLabel>
          <DataTable

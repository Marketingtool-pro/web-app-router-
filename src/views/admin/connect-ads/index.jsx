  ...
  return (
    <Box
      sx={{
        ...
        bgcolor: "#0a0a0f",
        backgroundImage:
          "radial-gradient(ellipse at 20% 50%, rgba(128,90,245,0.08) 0%, transparent 50%), radial-gradient(ellipse at 80% 50%, rgba(24,119,242,0.06) 0%, transparent 50%)",
        p: 3,
      }}
    >
      <Box
        ...
        >
          ...
          <Box
            sx={{
              ...
              height: 250,
              borderRadius: "50%",
              background: "radial-gradient(circle, rgba(128,90,245,0.2) 0%, transparent 70%)",
            }}
          />
          <Box
            sx={{
          ...
          <Stack sx={{ gap: 3, position: "relative", zIndex: 1 }}>
            ...
            <Typography
              variant="h4"
              sx={{ color: "#fff", fontWeight: 800, lineHeight: 1.2, letterSpacing: "-0.02em" }}
            >
              The SuperApp
              <br />
              for Digital
            ...
            <Typography
              variant="body2"
              sx={{ color: "rgba(255,255,255,0.55)", lineHeight: 1.7, maxWidth: 280 }}
            >
              Manage, optimize, and scale your ad campaigns across Meta platforms from one
              dashboard.
            </Typography>
          </Stack>
          ...
          <Stack sx={{ gap: 3.5, maxWidth: 400 }}>
            ...
            <Stack sx={{ gap: 1 }}>
              ...
              <Typography variant="body2" sx={{ color: "rgba(255,255,255,0.5)", lineHeight: 1.6 }}>
                This is to{" "}
                <strong style={{ color: "rgba(255,255,255,0.8)" }}>sync your ad data</strong>. You
                will not be charged during your{" "}
                <strong style={{ color: "#805AF5" }}>7-day free trial</strong>.
              </Typography>
            </Stack>
            ...
            <Stack sx={{ gap: 1.5 }}>
              {[
                ...
                <Stack key={i} direction="row" sx={{ alignItems: "flex-start", gap: 1.5 }}>
                  ...
                  <Typography
                    variant="body2"
                    sx={{ color: "rgba(255,255,255,0.7)", fontSize: 13.5, lineHeight: 1.5 }}
                  >
                    {text}
                  </Typography>
                </Stack>
            ...
            <Stack direction="row" sx={{ alignItems: "center", justifyContent: "center", gap: 3 }}>
              <Stack direction="row" sx={{ alignItems: "center", gap: 0.5 }}>
                ...
                <Typography
                  variant="caption"
                  sx={{ color: "rgba(255,255,255,0.5)", ml: 0.5, fontSize: 11 }}
                >
                  4.8 Rating
                </Typography>
              </Stack>
            ...
            <Typography
              variant="caption"
              sx={{ color: "rgba(255,255,255,0.25)", textAlign: "center", fontSize: 10.5 }}
            >

...
export default function CreateEmail() {
  ...
  if (selectedTool) {
    return (
      <Box
        sx={{ height: "calc(100vh - 120px)", overflow: "auto", px: { xs: 2, md: 3, lg: 4 }, py: 2 }}
      >
  ...
  return (
    <Box
      sx={{ height: "calc(100vh - 120px)", overflow: "auto", px: { xs: 2, md: 3, lg: 4 }, pb: 6 }}
    >
        ...
        <Stack direction="row" alignItems="center" spacing={1.5} sx={{ mb: 3 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ color: "text.secondary" }}>
              12 AI-powered email and copy tools
            </Typography>
          </Box>
        </Stack>

    ...
    <Box sx={{ height: 'calc(100vh - 120px)', overflow: 'auto', px: { xs: 2, md: 3, lg: 4 }, pb: 6 }}>
      <Box sx={{ maxWidth: 1400, mx: 'auto' }}>
        ...
        <Stack direction="row" alignItems="center" spacing={1.5} sx={{ mb: 3 }}>
          <Box sx={{ width: 36, height: 36, borderRadius: 2, display: 'flex', alignItems: 'center', justifyContent: 'center', bgcolor: 'rgba(6,182,212,0.12)', color: '#06b6d4' }}>
            <IconChartBar size={20} />
          </Box>
          <Box>
            <Typography sx={{ fontWeight: 700, fontSize: '1.3rem', letterSpacing: '-0.02em' }}>Get Insights</Typography>
            <Typography variant="body2" sx={{ color: 'text.secondary' }}>12 AI-powered analytics tools</Typography>
          </Box>
        </Stack>

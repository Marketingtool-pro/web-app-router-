  ...
  return (
    <GlassCard
      sx={{
        ...
        position: "relative",
        overflow: "hidden",
        animation: `slideUp 400ms ease-out ${delay}ms both`,
        "@keyframes slideUp": {
  ...
  if (!data || data.length === 0) {
    return (
      <Stack sx={{ alignItems: "center", justifyContent: "center", height: 280, gap: 1.5 }}>
        ...
        <Typography sx={{ fontSize: "0.85rem", fontWeight: 600, color: "rgba(248,248,248,0.35)" }}>
          No usage data yet
        </Typography>
        <Typography sx={{ fontSize: "0.75rem", color: "rgba(248,248,248,0.2)" }}>
          Start using AI tools to see your usage chart
        </Typography>
      </Stack>
    );
  }
          ...
          <Box key={platform} sx={{ px: 1, animation: `slideUp 400ms ease-out ${i * 60}ms both` }}>
            ...
            >
              ...
              <Stack direction="row" sx={{ alignItems: "baseline", gap: 0.75 }}>
                <Typography
                  sx={{ fontSize: "0.9rem", fontWeight: 800, color: "rgba(248,248,248,0.92)" }}
                >
                  {count}
                </Typography>
                <Typography
                  sx={{ fontSize: "0.65rem", fontWeight: 600, color: "rgba(248,248,248,0.3)" }}
                >
                  {pct}%
                </Typography>
              </Stack>
    ...
    <Stack spacing={3} sx={{ maxWidth: 1920, mx: "auto", width: "100%" }}>
      <Stack direction="row" sx={{ justifyContent: "space-between" }}>
        <Box>
          ...
          <Skeleton width={250} height={18} sx={{ mt: 0.5 }} />
        </Box>
  ...
  return (
    <Stack sx={{ maxWidth: 1920, mx: "auto", width: "100%" }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography sx={{ fontSize: "0.85rem", color: "rgba(248,248,248,0.35)" }}>
          0 generations in selected period
        </Typography>
      </Box>
        ...
        <Grid size={{ xs: 12, lg: 8 }}>
          <GlassCard>
            ...
            >
              ...
              <Typography
                sx={{ fontSize: "0.88rem", fontWeight: 700, color: "rgba(248,248,248,0.92)" }}
              >
                Usage Over Time
              </Typography>
            </Stack>
      ...
      <GlassCard>
        <Stack
          direction="row"
          sx={{ alignItems: "center", gap: 1, px: 3, py: 2, borderBottom: `1px solid ${G.border}` }}
        >
        ...
        <Stack sx={{ alignItems: "center", justifyContent: "center", py: 8, gap: 1.5 }}>
          ...
          <Typography sx={{ fontSize: "0.9rem", fontWeight: 700, color: "rgba(248,248,248,0.55)" }}>
          ...
          <Button
            ...
            sx={{
              ...
              "&:hover": { background: `linear-gradient(135deg, ${ACCENT}dd, ${ACCENT}aa)` },
            }}
          >
            Start Using Tools
          </Button>
...
export default function AnalyticsPage() {
  ...
  for (let i = days - 1; i >= 0; i--) {
    ...
    const count = filteredGens.filter(
      (g) => (g.created_at || g.$createdAt || "").split("T")[0] === dateStr,
    ).length;
  ...
  filteredGens.forEach((g) => {
    ...
    if (!toolCounts[slug]) {
      toolCounts[slug] = {
        name: g.tool_name || g.toolName || slug,
        count: 0,
        platform: g.platform || g.engine || "website",
      };
    }
    ...
    <Stack spacing={3} sx={{ maxWidth: 1920, mx: "auto", width: "100%" }}>
      ...
      >
        <Box>
          ...
          <Typography sx={{ fontSize: "0.85rem", color: "rgba(248,248,248,0.35)" }}>
            {filteredGens.length} generations in selected period
          </Typography>
        </Box>
      ...
      <GlassCard>
        ...
        {topTools.length > 0 ? (
          ...
          <Stack sx={{ alignItems: "center", justifyContent: "center", py: 8, gap: 1.5 }}>
            ...
            <Typography
              sx={{ fontSize: "0.9rem", fontWeight: 700, color: "rgba(248,248,248,0.55)" }}
            >
              No tool usage data yet
            </Typography>
            <Button

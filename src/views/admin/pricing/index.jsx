      ...
      <Stack spacing={5} sx={{ maxWidth: 1100, mx: "auto" }}>
        ...
        <Card sx={{ borderRadius: 3, border: 1, borderColor: "divider" }}>
          <CardContent sx={{ textAlign: "center", py: 3 }}>
            <Stack
              direction="row"
              sx={{ alignItems: "center", justifyContent: "center", gap: 1, mb: 1 }}
            >
        ...
        >
          <CardContent sx={{ textAlign: "center", py: 5 }}>
            ...
            >
              White-label solution for agencies managing 10+ client accounts. Unlimited generations,
        ...
        <Box sx={{ textAlign: "center" }}>
          ...
          <Grid container spacing={2} sx={{ justifyContent: "center" }}>
            {[
              {
                name: "Google Ads",
                desc: "Search, Display, Shopping, YouTube, Performance Max",
                color: "#4285F4",
              },
              {
                name: "Facebook / Meta",
              ...
              {
                name: "Instagram",
                desc: "Feed, Stories, Reels, Shopping, Carousel",
                color: "#E4405F",
              },
              {
                name: "TikTok",
                desc: "In-Feed, TopView, Brand Takeover, Spark Ads",
                color: "#010101",
              },
              {
                name: "LinkedIn",
                desc: "Sponsored Content, Message Ads, Lead Gen Forms",
                color: "#0A66C2",
              },
              {
                name: "E-commerce",
                desc: "Shopify, Amazon, Product Feed, Shopping Campaigns",
                color: "#96BF48",
              },
              {
                name: "Analytics & SEO",
                desc: "Google Analytics, SEO Audit, Keyword Research, Reports",
                color: "#F59E0B",
              },
            ].map((platform) => (

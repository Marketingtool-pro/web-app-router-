...
const META_OBJECTIVES = [
  {
    value: "conversions",
    label: "Conversions",
    desc: "Drive valuable actions on your website or app",
    icon: "🎯",
  },
  {
    value: "traffic",
  ...
  },
  {
    ...
    desc: "Reach people likely to remember your ads",
    icon: "📢",
  },
  {
    value: "leads",
    label: "Lead Generation",
    desc: "Collect leads with instant forms",
    icon: "📋",
  },
  {
    value: "engagement",
  ...
  },
  {
    value: "app_installs",
    label: "App Installs",
    desc: "Get people to install your app",
    icon: "📱",
  },
  {
    value: "video_views",
    label: "Video Views",
    desc: "Get more people to watch your videos",
    icon: "🎬",
  },
  {
    value: "messages",
    label: "Messages",
    desc: "Conversations on Messenger, WhatsApp, IG",
    icon: "💌",
  },
];
...
const GOOGLE_OBJECTIVES = [
  ...
  },
  {
    value: "shopping",
    label: "Shopping Ads",
    desc: "Products with images, prices, reviews",
    icon: "🛒",
  },
  { value: "video", label: "Video Ads", desc: "Reach people on YouTube", icon: "▶️" },
  {
    ...
    desc: "AI-optimized across all Google channels",
    icon: "🚀",
  },
  {
    value: "app",
    ...
    <Box>
      ...
      >
        ...
        <Typography variant="body2" sx={{ mt: 1 }}>
          ...
          <span style={{ color: "#805AF5", fontWeight: 600 }}>browse files</span>
        </Typography>
        <Typography variant="caption" color="text.disabled" sx={{ mt: 0.5, display: "block" }}>
          {platform === "meta"
            ? "Recommended: 1080×1080 (Feed) or 1080×1920 (Stories) • PNG, JPG up to 30MB"
            : "Recommended: 1200×628 (Display) or 1200×1200 (Responsive) • PNG, JPG up to 5MB"}
        </Typography>
        <input
          ref={fileRef}
          type="file"
        ...
        >
          <CardContent sx={{ p: 2.5 }}>
            ...
            <Typography variant="body2" sx={{ mb: 2, lineHeight: 1.6 }}>
              {form.primaryText ||
                "Your ad primary text goes here. Write compelling copy that speaks to your audience and drives them to take action."}
            </Typography>
            <Box
              sx={{
                width: "100%",
            ...
            >
              ...
              >
                {form.landingUrl || "yourwebsite.com"}
              </Typography>
              <Typography variant="subtitle2" sx={{ fontWeight: 600, mt: 0.25 }}>
                {form.headline || "Your Headline Goes Here"}
              </Typography>
              <Typography variant="caption" color="text.secondary">
                {form.description || "Your description text"}
              </Typography>
            </Box>
            <Button
              variant="contained"
        ...
        <CardContent sx={{ p: 2.5 }}>
          <Stack direction="row" sx={{ alignItems: "center", gap: 1, mb: 1 }}>
            ...
            <Box>
              ...
              >
                {form.displayUrl || "www.yoursite.com"}
              </Typography>
            </Box>
            <Chip
              label="Ad"
              size="small"
              sx={{ height: 16, fontSize: "0.55rem", ml: 0.5, bgcolor: "rgba(255,255,255,0.08)" }}
            />
          </Stack>
          <Typography
            variant="subtitle1"
            sx={{ fontWeight: 500, color: "#8AB4F8", lineHeight: 1.3 }}
          >
            {form.headline || "Your Headline"}
            {form.headline2 ? ` | ${form.headline2}` : ""}
            {form.headline3 ? ` | ${form.headline3}` : ""}
          </Typography>
          <Typography variant="body2" color="text.secondary" sx={{ mt: 0.75, lineHeight: 1.5 }}>
            {form.description ||
              "Your ad description will appear here. Write compelling copy that highlights your unique value proposition."}
          </Typography>
          {form.description2 && (
...
function CampaignBuilder({ onSave, onCancel, accounts }) {
  ...
  const handleLaunch = async () => {
    ...
    setLaunchProgress(0);
    setLaunchStatus(
      "Submitting campaign to " + (form.platform === "google" ? "Google Ads" : "Meta Ads") + "...",
    );
    setLaunchError(null);
      ...
      <Stack direction="row" sx={{ alignItems: "center", justifyContent: "space-between", mb: 3 }}>
        <Stack direction="row" sx={{ alignItems: "center", gap: 2 }}>
          ...
          <Stack direction="row" sx={{ alignItems: "center", gap: 1 }}>
            ...
            <Typography variant="h5" sx={{ fontWeight: 700 }}>
              {form.platform
                ? `New ${form.platform === "google" ? "Google" : "Meta"} Campaign`
                : "Create Campaign"}
            </Typography>
          </Stack>
        </Stack>
        {activeStep === STEPS.length - 1 && (
          <Button
            ...
            disabled={saving}
            startIcon={
              saving ? <CircularProgress size={16} color="inherit" /> : <IconRocket size={18} />
            }
            sx={{ px: 4, height: 44 }}
          >
              ...
              {[
                {
                  key: "google",
                  name: "Google Ads",
                  sub: "Search, Display, Shopping, YouTube, Performance Max",
                  img: "/images/icons/marketing-strategy-3d.png",
                },
                {
                  key: "meta",
                  name: "Meta Ads",
                  sub: "Facebook, Instagram, Messenger, Audience Network",
                  img: "/images/icons/facebook-3d.png",
                },
              ].map((p) => (
                <Grid key={p.key} size={{ xs: 12, sm: 6 }}>
                  <Card
                    onClick={() => {
                      update("platform", p.key);
                      update("objective", "");
                    }}
                    sx={{
                      p: 4,
                      ...
                      border: "2px solid",
                      borderColor:
                        form.platform === p.key ? "primary.main" : "rgba(255,255,255,0.06)",
                  ...
                  >
                    ...
                    {form.platform === p.key && (
                      <Chip label="Selected" size="small" color="primary" sx={{ mt: 1.5 }} />
                    )}
                  </Card>
                </Grid>
              ))}
          ...
          {form.platform && (
            <Box>
              ...
              <FormControl fullWidth>
                <InputLabel>
                  Select {form.platform === "google" ? "Google" : "Meta"} Ad Account
                </InputLabel>
                <Select
                  value={selectedAccount}
                  label={`Select ${form.platform === "google" ? "Google" : "Meta"} Ad Account`}
                  ...
                  {(accounts || [])
                    ...
                    .map((acc) => (
                      <MenuItem key={acc.id || acc.account_id} value={acc.id || acc.account_id}>
                        {acc.name || acc.account_name || acc.id}
                      </MenuItem>
                    ))}
                </Select>
              </FormControl>
              {(accounts || []).filter((a) => a.platform === form.platform).length === 0 && (
                <Alert severity="warning" sx={{ mt: 1.5, borderRadius: 2 }}>
                  No {form.platform === "google" ? "Google" : "Meta"} ad account connected. Connect
                  one in Settings → Connected Services.
                </Alert>
              )}
            </Box>
          )}
                  ...
                  <Grid key={obj.value} size={{ xs: 12, sm: 6, md: 4 }}>
                    <Card
                      ...
                      sx={{
                        ...
                        border: "2px solid",
                        borderColor:
                          form.objective === obj.value ? "primary.main" : "rgba(255,255,255,0.06)",
                        bgcolor:
                          form.objective === obj.value ? "rgba(128,90,245,0.08)" : "transparent",
              ...
              <CardContent sx={{ p: 3 }}>
                ...
                <Stack spacing={3}>
                  <TextField
                    ...
                    placeholder={
                      form.platform === "google"
                        ? "e.g. Google Search - Brand Keywords Q1 2026"
                        : "e.g. Meta Conversions - Summer Sale 2026"
                    }
                    required
                  />
                  <TextField
                  ...
                  >
                    {aiGenerating
                      ...
                      : "AI Generate — Headlines, Copy, Audience, Budget"}
                  </Button>
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid size={{ xs: 6 }}>
                      <TextField
                        label={form.budgetType === "daily" ? "Daily Budget" : "Lifetime Budget"}
                        type="number"
                        fullWidth
                        value={form.budget}
                  ...
                  <Alert severity="info" variant="outlined" sx={{ py: 0.5 }}>
                    {form.budgetType === "daily"
                      ? `Estimated monthly spend: $${(form.budget * 30).toLocaleString()}`
                      : `Estimated daily spend: $${Math.round(form.budget / 30).toLocaleString()}`}
                  </Alert>
                  <Divider />
                  <Typography variant="subtitle1" sx={{ fontWeight: 600 }}>
                    Schedule
                  ...
                  <FormControlLabel
                    ...
                    label="Run continuously (no end date)"
                  />
                </Stack>
              </CardContent>
            </Card>
            ...
            <Card sx={{ border: "1px solid rgba(255,255,255,0.06)", position: "sticky", top: 20 }}>
              <CardContent sx={{ p: 3 }}>
                ...
                <Stack spacing={2}>
                  <Box>
                    ...
                    <Stack direction="row" sx={{ alignItems: "center", gap: 1, mt: 0.5 }}>
                      ...
                      <Typography variant="subtitle2">
                        {form.platform === "google" ? "Google Ads" : "Meta Ads"}
                      </Typography>
                    </Stack>
                  </Box>
                  <Divider />
                  ...
                  <Box>
                    <Typography variant="caption" color="text.disabled">
                      {form.budgetType === "daily" ? "Daily Budget" : "Lifetime Budget"}
                    </Typography>
              ...
              <CardContent sx={{ p: 3 }}>
                ...
                <Stack spacing={3}>
                  <TextField
                    ...
                    placeholder="e.g. United States, United Kingdom, Canada, Australia"
                    helperText="Separate multiple locations with commas"
                  />
                  <Grid container spacing={2} sx={{ alignItems: "center" }}>
                    <Grid size={{ xs: 8 }}>
                      <Typography variant="subtitle2" sx={{ mb: 1 }}>
                        Age Range: {form.ageRange[0]} — {form.ageRange[1]}
                        {form.ageRange[1] === 65 ? "+" : ""}
                      </Typography>
                      <Slider
                        value={form.ageRange}
                  ...
                  <TextField
                    ...
                    placeholder={
                      form.platform === "google"
                        ? "e.g. marketing software, CRM tools, SaaS, business automation"
                        : "e.g. Digital Marketing, E-commerce, Entrepreneurship, Small Business"
                    }
                  ...
                  <FormControlLabel
                    control={
                      <Switch
                        checked={form.autoPlacement}
                        onChange={(e) => update("autoPlacement", e.target.checked)}
                      />
                    }
                    label={
                      form.platform === "meta"
                        ? "Advantage+ Placements (recommended)"
                        : "Auto-optimize networks (recommended)"
                    }
                  />
                  {!form.autoPlacement && (
                  ...
                  <TextField
                    ...
                    placeholder={
                      form.platform === "meta"
                        ? "e.g. Website visitors 30 days, Lookalike 1%"
                        : "e.g. Customer match list, Similar audiences"
                    }
                  />
                  <TextField
              ...
              <CardContent sx={{ p: 3 }}>
                ...
                <Stack spacing={1.5}>
                  ...
                  <Stack direction="row" sx={{ justifyContent: "space-between" }}>
                    ...
                    <Typography variant="caption">
                      {form.autoPlacement ? "Auto" : `${form.placements.length} selected`}
                    </Typography>
                  </Stack>
                </Stack>
              </CardContent>
                ...
                <Stack spacing={3}>
                  ...
                  {form.platform === "meta" && (
                    <TextField
                      ...
                      placeholder="Write the main body text. This appears above the image in the feed."
                      helperText={`${form.primaryText.length}/125 characters recommended`}
                    />
                  )}
                  <TextField
                    label={form.platform === "google" ? "Headline 1 (required)" : "Headline"}
                    fullWidth
                    value={form.headline}
                    onChange={(e) => update("headline", e.target.value)}
                    placeholder={
                      form.platform === "google"
                        ? "e.g. Get 50% Off Marketing Tools"
                        : "e.g. Transform Your Marketing Today"
                    }
                    helperText={`${form.headline.length}/${form.platform === "google" ? 30 : 40} characters`}
                  />
                  {form.platform === "google" && (
                    <>
                      <TextField
                        label="Headline 2 (required)"
                        fullWidth
                        value={form.headline2}
                        onChange={(e) => update("headline2", e.target.value)}
                        placeholder="e.g. Free 14-Day Trial"
                        helperText={`${(form.headline2 || "").length}/30 characters`}
                      />
                      <TextField
                        label="Headline 3 (optional)"
                        fullWidth
                        value={form.headline3}
                        onChange={(e) => update("headline3", e.target.value)}
                        placeholder="e.g. Start Growing Today"
                        helperText={`${(form.headline3 || "").length}/30 characters`}
                      />
                      <TextField
                        label="Display URL Path"
                        fullWidth
                        value={form.displayUrl}
                        onChange={(e) => update("displayUrl", e.target.value)}
                        placeholder="www.yoursite.com/offer"
                      />
                    </>
                  )}
                  <TextField
                    label={form.platform === "google" ? "Description 1" : "Link Description"}
                    fullWidth
                    multiline
                    rows={2}
                    ...
                    helperText={`${form.description.length}/${form.platform === "google" ? 90 : 30} characters`}
                  />
                  {form.platform === "google" && (
                    <TextField
                      ...
                      helperText={`${(form.description2 || "").length}/90 characters`}
                    />
                  )}
                  <FormControl fullWidth>
      ...
      {activeStep === 4 && (
        <Stack spacing={3}>
          ...
          {launchPhase && launchPhase !== "error" && (
            <Card
              sx={{ border: "1px solid rgba(128,90,245,0.3)", bgcolor: "rgba(128,90,245,0.04)" }}
            >
                ...
                {launchPhase === "done" ? (
                  ...
                  >
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          border: "1px solid rgba(62,183,94,0.25)",
                          display: "flex",
                          alignItems: "center",
                          justifyContent: "center",
                        }}
                    ...
                    {launchOutput?.summary && (
                      <Box
                        sx={{
                          ...
                          border: "1px solid rgba(128,90,245,0.15)",
                        }}
                      >
                        <Typography
                          sx={{
                    ...
                    {launchOutput?.data?.campaign && (
                      ...
                      >
                        ...
                        <Grid container spacing={1.5}>
                          {Object.entries(launchOutput.data.campaign)
                            ...
                            .map(([k, v]) => (
                              <Grid key={k} size={{ xs: 6, md: 3 }}>
                                ...
                                >
                                  ...
                                  >
                                    {typeof v === "number" && k.toLowerCase().includes("budget")
                                      ? `$${v.toLocaleString()}`
                                      : Array.isArray(v)
                                        ? v.join(", ")
                                        : String(v)}
                    ...
                    {launchOutput?.data?.projections && (
                      ...
                      >
                        <Typography
                          sx={{ fontWeight: 800, fontSize: "1rem", mb: 2, color: "#34d399" }}
                        >
                          ...
                          {Object.entries(launchOutput.data.projections).map(([k, v]) => (
                            <Grid key={k} size={{ xs: 6, md: 3 }}>
                              ...
                              >
                                ...
                                <Typography
                                  sx={{ fontSize: "1.1rem", fontWeight: 900, color: "#34d399" }}
                                >
                                  {typeof v === "number"
                                    ? k.includes("Rate") || k.includes("CTR")
                                      ? `${v}%`
                                      : k.includes("CPC") || k.includes("CPA") || k.includes("CPM")
                                        ? `$${v}`
                                        : k.includes("ROAS")
                                          ? `${v}x`
                                          : v.toLocaleString()
                    ...
                    {(launchOutput?.data?.adGroups || launchOutput?.data?.adSets) && (
                      ...
                      >
                        <Typography sx={{ fontWeight: 800, fontSize: "1rem", mb: 2 }}>
                          {launchOutput.data.adGroups ? "Ad Groups" : "Ad Sets"} (
                          {(launchOutput.data.adGroups || launchOutput.data.adSets).length})
                        </Typography>
                        <Stack spacing={1.5}>
                          {(launchOutput.data.adGroups || launchOutput.data.adSets).map(
                            (group, i) => (
                              <Box
                                key={i}
                                sx={{
                    ...
                    {launchOutput?.data?.ads && (
                      ...
                      >
                        <Typography sx={{ fontWeight: 800, fontSize: "1rem", mb: 2 }}>
                          Ad Creatives ({launchOutput.data.ads.length})
                        </Typography>
                        <Grid container spacing={2}>
                    ...
                    {launchOutput?.data?.recommendations && (
                      ...
                      >
                        <Typography
                          sx={{ fontWeight: 800, fontSize: "0.9rem", color: "#fbbf24", mb: 1.5 }}
                        >
                          AI Recommendations
                        </Typography>
                        <Stack spacing={1}>
                          {launchOutput.data.recommendations.map((rec, i) => (
                            ...
                            >
                              ...
                              >
                                <Typography
                                  sx={{ fontSize: "0.58rem", fontWeight: 900, color: "#fbbf24" }}
                                >
                                  {i + 1}
                                </Typography>
                              </Box>
                    ...
                    {launchOutput?.data?.aiAdCopy && (
                      ...
                      >
                        <Typography
                          sx={{ fontWeight: 800, fontSize: "0.9rem", color: "#c084fc", mb: 1.5 }}
                        >
                    ...
                    {launchOutput?.data?.marketResearch && (
                      ...
                      >
                        <Typography
                          sx={{ fontWeight: 800, fontSize: "0.9rem", color: "#60a5fa", mb: 1.5 }}
                        >
                          Market Intelligence
                        </Typography>
                        <Typography
                        ...
                        >
                          {typeof launchOutput.data.marketResearch === "string"
                            ? launchOutput.data.marketResearch
                            : JSON.stringify(launchOutput.data.marketResearch, null, 2)}
                        </Typography>
                      </Box>
                    )}
                      ...
                      <LinearProgress
                        ...
                        sx={{
                          ...
                          "& .MuiLinearProgress-bar": {
                            borderRadius: 3,
                            background: "linear-gradient(90deg, #1BA2DB, #805AF5)",
                          },
                        }}
                      />
                      <Typography
          ...
          {!launchPhase && (
            <Alert severity="info" icon={<IconRocket size={20} />}>
              Review your campaign settings. Once launched, your campaign will be submitted for
              platform review and typically goes live within 24 hours.
            </Alert>
          )}
          <Grid container spacing={3}>
            <Grid size={{ xs: 12, lg: 8 }}>
                    ...
                    <Stack direction="row" sx={{ alignItems: "center", gap: 2, mb: 2 }}>
                      ...
                      <Box>
                        ...
                        <Stack direction="row" spacing={1}>
                          <Chip
                            label={form.platform === "google" ? "Google Ads" : "Meta Ads"}
                            size="small"
                            color="primary"
                            variant="outlined"
                          />
                ...
                <Card sx={{ border: "1px solid rgba(255,255,255,0.06)" }}>
                  <CardContent sx={{ p: 3 }}>
                    ...
                    <Stack direction="row" spacing={1} sx={{ mt: 1.5 }}>
                      ...
                      {form.landingUrl && (
                        <Chip label={form.landingUrl} size="small" variant="outlined" />
                      )}
                    </Stack>
                    {form.images.length > 0 && (
      ...
      {campaigns.length === 0 ? (
        <Card sx={{ border: "1px solid rgba(255,255,255,0.06)" }}>
          <CardContent sx={{ py: 8, textAlign: "center" }}>
            <img
              src="/images/icons/promotion-3d.png"
              alt=""
              width={96}
              height={96}
            ...
            >
              Launch advertising campaigns on Meta and Google. Set your objective, define your
              audience, create compelling ads, and start driving results.
            </Typography>

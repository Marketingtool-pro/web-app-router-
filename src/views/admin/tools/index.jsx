...
const TOOL_IMAGE_MAP = (() => {
  ...
  allTools.forEach((tool) => {
    ...
    if (!cfg) {
      map[tool.slug] = "/images/tools/ai-tools/ai-01.jpg";
      return;
    }
    ...
    <Box
      ...
      sx={{
        ...
        "&:hover": {
          ...
          boxShadow:
            "0 20px 48px -12px rgba(128,90,245,0.15), 2px 4px 16px 0px rgba(248,248,248,0.06) inset",
        },
      ...
      >
        ...
        <Box
          sx={{
            ...
            inset: 0,
            background:
              "linear-gradient(135deg, rgba(14,12,21,0.7) 0%, rgba(14,12,21,0.4) 50%, rgba(14,12,21,0.65) 100%)",
          }}
        />
      </Box>

    ...
    <Grid container columns={12} rowSpacing={{ xs: 2, sm: 3, md: 4 }} columnSpacing={{ xs: 2, sm: 3, md: 5 }}>
      ...
      <Grid size={{ xs: 12, sm: 4 }}>
        <Stack sx={{ gap: 0.5 }}>
          ...
          <Typography variant="subtitle2">{data.zipCode}</Typography>
        </Stack>
      </Grid>
      <Grid size={{ xs: 12, sm: 4 }}>
        <Stack sx={{ gap: 0.5 }}>
      ...
      <Grid size={{ xs: 12, sm: 4 }}>
        <Stack sx={{ gap: 0.5 }}>
          ...
          <Typography variant="subtitle2">{data.billingCycle}</Typography>
        </Stack>
      </Grid>
      <Grid size={{ xs: 12, sm: 4 }}>
        <Stack sx={{ gap: 0.5 }}>
      ...
      <Grid size={{ xs: 12, sm: 4 }}>
        <Stack sx={{ gap: 0.5 }}>
          ...
          <Typography variant="subtitle2">{data.loginDate}</Typography>
        </Stack>
      </Grid>
    </Grid>
  );

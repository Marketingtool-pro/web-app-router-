...
// @project
import { handleAccountFilter, initialAccountFilter, useGetAccountFilter } from "../api";
import MainCard from "@/components/MainCard";
import { varSlide } from "@/components/third-party/motion/animate/dialog";
import SimpleBar from "@/components/third-party/SimpleBar";

// @types
import { BillingStatus, Plans } from "@/sections/account/type";

// @assets
import { IconFilter, IconX } from "@tabler/icons-react";

const planOptions = [Plans.BASIC, Plans.STARTER, Plans.ENTERPRISE];
...
const defaultFilter = initialAccountFilter.columnFilters;

/***************************  FILTER - FORM  ***************************/

function AccountFilterForm({ defaultValues, setDefaultValues, setFilterAnchorEl, maxHeight }) {
  ...
  const onSubmit = (data) => {
    ...
    handleAccountFilter({ columnFilters: filters, globalFilter: data.search });
    ...
    <form>
      ...
      >
        <Button
          ...
          onClick={() => {
            const defaults = {
              search: initialAccountFilter.globalFilter || "",

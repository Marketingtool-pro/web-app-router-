  ...
  return (
    <Grid container sx={{ height: "100vh" }}>
      ...
      <Grid
        ...
        sx={{ bgcolor: "grey.100", pt: 7, display: { xs: "none", md: "block" } }}
      >
        <Stack sx={{ height: 1, justifyContent: "space-between" }}>
          <Stack sx={{ alignItems: "center", gap: 2, px: 3 }}>
            <Typography variant="body2" color="grey.700" align="center" sx={{ maxWidth: 400 }}>
              AI-powered ad management platform. Create campaigns, optimize performance, and scale
              your marketing with intelligent automation.
            </Typography>
          </Stack>

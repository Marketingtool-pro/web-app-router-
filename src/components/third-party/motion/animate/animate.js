export function createAnimations(distance = 100) {
  ...
  const animations = {
    ...
    zoomInUp: {
      initial: { y: slideDistance, scale: 0.5, opacity: 0 },
    ...
    zoomInLeft: {
      initial: { x: -slideDistance, scale: 0.5, opacity: 0 },
    ...
    zoomOutUp: {
      ...
      animate: { y: -slideDistance, scale: 0.5, opacity: 0 },
    },
    zoomOutDown: {
      initial: { y: 0, scale: 1, opacity: 1 },
      animate: { y: slideDistance, scale: 0.5, opacity: 0 },
    ...
    zoomOutLeft: {
      ...
      animate: { x: -slideDistance, scale: 0.5, opacity: 0 },
    },
    zoomOutRight: {
      initial: { x: 0, scale: 1, opacity: 1 },
      animate: { x: slideDistance, scale: 0.5, opacity: 0 },

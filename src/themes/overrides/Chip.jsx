          ...
          variants: [
              ...
              style: ({ ownerState }) => {
                ...
                return {
                  ...(paletteColor && {
                    ...
                    ...theme.applyStyles("dark", {
                      backgroundColor: withAlpha(paletteColor.lighter, 0.4),
                    }),
                  }),
                  "& .MuiChip-label": {
                  ...
                  "& .MuiChip-deleteIcon": {
                    ...
                    ...(paletteColor && {
                      ...
                      ...theme.applyStyles("dark", {
                        ...
                        "&:hover": { color: paletteColor.darker },
                      }),
                    }),
                  },
                  "&.Mui-focusVisible": {
            ...
            },
            {
              ...
              style: ({ ownerState }) => {
                ...
                return {
                  ...theme.applyStyles("dark", {
                    ...(paletteColor && { backgroundColor: paletteColor.light }),
                  }),
                  "& .MuiChip-label": {
                    padding: "2px 8px", // Padding for the label
                  },
              ...
              style: ({ ownerState }) => {
                ...
                return {
                  ...
                  "& .MuiChip-deleteIcon": {
                    ...
                    marginLeft: -2,
                    ...(paletteColor === undefined && {
                      color: withAlpha(theme.vars.palette.text.secondary, 0.8),
                    }),
                    ...(paletteColor && {
